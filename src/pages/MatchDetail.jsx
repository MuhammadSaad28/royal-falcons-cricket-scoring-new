...
export default function MatchDetail() {
  ...
  const matchFinished = targetInfo && targetInfo.required === 0 || (currentInnings && currentInnings.wickets === match.totalPlayersPerTeam - 1 ) || (currentInnings && currentInnings.overs >= match.overs);
              ...
              <div className="text-center order-2">
                ...
                {matchFinished && (
                  <div className="bg-green-600/20 rounded-xl p-4 border border-green-500/30">
                    <div className="text-green-400 text-xl font-bold uppercase tracking-wider mb-1">
                      Match Finished
                    </div>
